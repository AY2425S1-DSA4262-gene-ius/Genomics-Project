...
if __name__ == '__main__':
    ...
    parser.add_argument('--x_train_data_path', type=str, help='Path to the train reads CSV.')
    parser.add_argument('--y_train_data_path', type=str, help='Path to the train data labels.')
